...
export default function FlightResultsPoller({
  ...
  useEffect(() => {
    ...
    // Wait 8 seconds before starting to poll (give time for search to complete and save to database)
    setTimeout(() => {
    ...
    }, 8000) // Wait 8 seconds before starting to poll (give database time to save)
